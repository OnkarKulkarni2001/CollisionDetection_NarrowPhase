...
//	this->m_eye += glm::vec3(0.0f, 0.0f, scaledDistance);
	...
	this->m_eye.x += (this->m_target.x * scaledDistance);
	//this->m_eye.y += (this->m_target.y * scaledDistance);
	this->m_eye.z += (this->m_target.z * scaledDistance);
	return;
}
...
//	this->m_eye += glm::vec3(scaledDistance, 0.0f, 0.0f);
	...
	this->m_eye.x += (moveSideWaysDirection.x * scaledDistance);
	//this->m_eye.y += (moveSideWaysDirection.y * scaledDistance);
	this->m_eye.z += (moveSideWaysDirection.z * scaledDistance);
