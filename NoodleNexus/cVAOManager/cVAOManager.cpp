...
//    std::ifstream plyFile("assets/models/bun_zipper_res3.ply");
	...
	for (unsigned index = 0; index != modelDrawInfo.numberOfVertices; index++)
	{
		...
		modelDrawInfo.pVertices->r = 1;
		modelDrawInfo.pVertices->g = 1;
		modelDrawInfo.pVertices->b = 1;
...
bool readPlyFile_XYZ_N_rgba_UV_non_rgba(sModelDrawInfo& modelDrawInfo)
{
...
//	}
	...
	{
		if (!readPlyFile_XYZ_N_rgba_UV_non_rgba(drawInfo))
		{
			return false;
		}
	}
